    ...
    <div id="wrapper" style="background-color:#b59146">
        ...
        <nav style="background-color:#b59146" class="navbar navbar-default top-navbar" role="navigation">
            ...
            <ul class="nav navbar-top-links navbar-right" style="background-color:#b59146">
                <li class="dropdown" style="background-color:#b59146">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                        <i style="background-color:#b59146" class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            <img src="assets/img/avani.png" style="height:100px;"><small>Payment Details </small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
