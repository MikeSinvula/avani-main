    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.php">SETTINGS </a>
            </div>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--End Advanced Tables -->
						...
						if(isset($_POST['in']))
						{
							...
							$newsql ="INSERT INTO `members`(username, password) VALUES ('$newus','$newps')";
						...
						header("Location: membersetting.php");
						}
						?>
				...
				if(isset($_POST['up']))
				{
					...
					$upsql = "UPDATE `members` SET `username`='$username',`password`='$password' WHERE id = '$id'";
